"""
Django settings for geop_44574 project.
...
WSGI_APPLICATION = 'geop_44574.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "geop_44574 API",
    "DESCRIPTION": "API documentation for geop_44574 App",
    "VERSION": "v1",
}
